package com.breezefieldsalesdemo.features.nearbyshops.presentation
...
import com.breezefieldsalesdemo.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
...
import com.breezefieldsalesdemo.features.addshop.model.QuestionSubmit
...
import com.breezefieldsalesdemo.features.addshop.presentation.*
...
import com.breezefieldsalesdemo.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
...
import com.breezefieldsalesdemo.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldsalesdemo.features.shopdetail.presentation.AddCollectionDialog
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldsalesdemoApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
