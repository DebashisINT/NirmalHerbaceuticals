package com.breezefieldsalesdemo.features.commondialogsinglebtn
...
import com.breezefieldsalesdemo.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldsalesdemo.app.domain.VisitRemarksEntity
...
import com.breezefieldsalesdemo.features.addshop.presentation.ProspectListDialog
import com.breezefieldsalesdemo.features.dashboard.presentation.DashboardActivity
import com.breezefieldsalesdemo.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldsalesdemo.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldsalesdemo/files", "recorded_audio${System.currentTimeMillis()}.mp3")
