...
import com.breezefieldsalesdemo.*
import com.breezefieldsalesdemo.R
import com.breezefieldsalesdemo.app.*
import com.breezefieldsalesdemo.app.NewFileUtils.browseDocuments
import com.breezefieldsalesdemo.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesdemo.app.NewFileUtils.getExtension
import com.breezefieldsalesdemo.app.domain.*
import com.breezefieldsalesdemo.app.types.DashboardType
import com.breezefieldsalesdemo.app.types.FragType
import com.breezefieldsalesdemo.app.types.TopBarConfig
import com.breezefieldsalesdemo.app.uiaction.DisplayAlert
import com.breezefieldsalesdemo.app.utils.*
import com.breezefieldsalesdemo.app.utils.AppUtils.Companion.isProfile
...
import com.breezefieldsalesdemo.features.NewQuotation.*
...
import com.breezefieldsalesdemo.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesdemo.features.SearchLocation.locationInfoModel
import com.breezefieldsalesdemo.features.TA.ViewAllTAListFragment
import com.breezefieldsalesdemo.features.achievement.AchievementFragment
import com.breezefieldsalesdemo.features.activities.presentation.*
import com.breezefieldsalesdemo.features.addAttendence.*
import com.breezefieldsalesdemo.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesdemo.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesdemo.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesdemo.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesdemo.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesdemo.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesdemo.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesdemo.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesdemo.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesdemo.features.alarm.model.AlarmData
import com.breezefieldsalesdemo.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesdemo.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesdemo.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesdemo.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesdemo.features.attendance.AttendanceFragment
import com.breezefieldsalesdemo.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesdemo.features.attendance.model.AttendanceRequest
import com.breezefieldsalesdemo.features.attendance.model.AttendanceResponse
import com.breezefieldsalesdemo.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesdemo.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesdemo.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesdemo.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesdemo.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesdemo.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesdemo.features.billing.presentation.BillingListFragment
import com.breezefieldsalesdemo.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesdemo.features.chat.model.ChatListDataModel
import com.breezefieldsalesdemo.features.chat.model.ChatUserDataModel
import com.breezefieldsalesdemo.features.chat.model.GroupUserDataModel
import com.breezefieldsalesdemo.features.chat.presentation.*
import com.breezefieldsalesdemo.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesdemo.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesdemo.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesdemo.features.chatbot.presentation.SelectLanguageDialog
...
import com.breezefieldsalesdemo.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.breezefieldsalesdemo.features.contacts.AddOpptFrag
...
import com.breezefieldsalesdemo.features.contacts.ContactsFrag
import com.breezefieldsalesdemo.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesdemo.features.contacts.SchedulerViewFrag
import com.breezefieldsalesdemo.features.contacts.TemplateAddFrag
import com.breezefieldsalesdemo.features.contacts.TemplateViewFrag
import com.breezefieldsalesdemo.features.contacts.ViewCrmOpptFrag
import com.breezefieldsalesdemo.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesdemo.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesdemo.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesdemo.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesdemo.features.damageProduct.ShopDamageProductSubmitFrag
...
import com.breezefieldsalesdemo.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesdemo.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
...
import com.breezefieldsalesdemo.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesdemo.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesdemo.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesdemo.features.document.presentation.DocumentListFragment
import com.breezefieldsalesdemo.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesdemo.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesdemo.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesdemo.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesdemo.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesdemo.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesdemo.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesdemo.features.home.presentation.HomeFragment
import com.breezefieldsalesdemo.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesdemo.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesdemo.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesdemo.features.lead.LeadFrag
import com.breezefieldsalesdemo.features.lead.ViewLeadFrag
import com.breezefieldsalesdemo.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesdemo.features.leaveapplynew.LeaveHome
import com.breezefieldsalesdemo.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesdemo.features.localshops.LocalShopListFragment
import com.breezefieldsalesdemo.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesdemo.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesdemo.features.location.*
...
import com.breezefieldsalesdemo.features.login.model.alarmconfigmodel.AlarmConfigDataModel
...
import com.breezefieldsalesdemo.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesdemo.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesdemo.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesdemo.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesdemo.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesdemo.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesdemo.features.member.MapViewForTeamFrag
import com.breezefieldsalesdemo.features.member.model.TeamLocDataModel
import com.breezefieldsalesdemo.features.member.model.TeamShopListDataModel
import com.breezefieldsalesdemo.features.member.presentation.*
import com.breezefieldsalesdemo.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesdemo.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesdemo.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesdemo.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesdemo.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesdemo.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesdemo.features.myjobs.presentation.*
import com.breezefieldsalesdemo.features.mylearning.MyLearningFragment
import com.breezefieldsalesdemo.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesdemo.features.myprofile.presentation.MyProfileFragment
...
import com.breezefieldsalesdemo.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesdemo.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesdemo.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesdemo.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesdemo.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesdemo.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesdemo.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesdemo.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesdemo.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesdemo.features.newcollectionreport.*
import com.breezefieldsalesdemo.features.notification.NotificationFragment
import com.breezefieldsalesdemo.features.orderITC.CartListFrag
import com.breezefieldsalesdemo.features.orderITC.OrderListFrag
import com.breezefieldsalesdemo.features.orderITC.ProductListFrag
import com.breezefieldsalesdemo.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsalesdemo.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsalesdemo.features.orderITC.ViewOrdDtls
import com.breezefieldsalesdemo.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesdemo.features.orderList.NewOrderListFragment
import com.breezefieldsalesdemo.features.orderList.OrderListFragment
import com.breezefieldsalesdemo.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesdemo.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesdemo.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesdemo.features.orderhistory.TimeLineFragment
...
import com.breezefieldsalesdemo.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesdemo.features.performance.GpsStatusFragment
import com.breezefieldsalesdemo.features.performance.PerformanceFragment
...
import com.breezefieldsalesdemo.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsalesdemo.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesdemo.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesdemo.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesdemo.features.photoReg.*
import com.breezefieldsalesdemo.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesdemo.features.quotation.presentation.*
import com.breezefieldsalesdemo.features.reimbursement.presentation.*
import com.breezefieldsalesdemo.features.report.presentation.*
import com.breezefieldsalesdemo.features.returnsOrder.*
import com.breezefieldsalesdemo.features.settings.presentation.SettingsFragment
import com.breezefieldsalesdemo.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesdemo.features.shopdetail.presentation.*
import com.breezefieldsalesdemo.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesdemo.features.stock.StockDetailsFragment
import com.breezefieldsalesdemo.features.stock.StockListFragment
...
import com.breezefieldsalesdemo.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesdemo.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesdemo.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesdemo.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesdemo.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesdemo.features.survey.SurveyFrag
import com.breezefieldsalesdemo.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesdemo.features.survey.SurveyViewFrag
import com.breezefieldsalesdemo.features.task.presentation.AddTaskFragment
import com.breezefieldsalesdemo.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesdemo.features.task.presentation.EditTaskFragment
import com.breezefieldsalesdemo.features.task.presentation.TaskListFragment
import com.breezefieldsalesdemo.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesdemo.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesdemo.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesdemo.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesdemo.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesdemo.features.viewAllOrder.CartFragment
import com.breezefieldsalesdemo.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesdemo.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesdemo.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesdemo.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesdemo.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesdemo.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
...
import com.breezefieldsalesdemo.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesdemo.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesdemo.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesdemo.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesdemo.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesdemo.features.weather.presentation.WeatherFragment
import com.breezefieldsalesdemo.mappackage.MapActivity
import com.breezefieldsalesdemo.mappackage.MapActivityWithoutPath
...
import com.breezefieldsalesdemo.features.login.model.NewSettingsResponseModel
import com.breezefieldsalesdemo.features.mylearning.AllTopicsWiseContents
import com.breezefieldsalesdemo.features.mylearning.BookmarkFetchResponse
import com.breezefieldsalesdemo.features.mylearning.BookmarkFrag
import com.breezefieldsalesdemo.features.mylearning.BookmarkPlayFrag
import com.breezefieldsalesdemo.features.mylearning.KnowledgeHubAllVideoList
import com.breezefieldsalesdemo.features.mylearning.LeaderboardLmsFrag
import com.breezefieldsalesdemo.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldsalesdemo.features.mylearning.MyLearningAllVideoList
import com.breezefieldsalesdemo.features.mylearning.MyLearningTopicList
import com.breezefieldsalesdemo.features.mylearning.MyLearningVideoPlay
import com.breezefieldsalesdemo.features.mylearning.MyPerformanceFrag
import com.breezefieldsalesdemo.features.mylearning.MyTopicsWiseContents
import com.breezefieldsalesdemo.features.mylearning.NotificationLMSFragment
import com.breezefieldsalesdemo.features.mylearning.SearchLmsFrag
import com.breezefieldsalesdemo.features.mylearning.SearchLmsKnowledgeFrag
import com.breezefieldsalesdemo.features.mylearning.SearchLmsLearningFrag
...
// Log.w(TAG, errorMessage);
    ...
    override fun loadFragment(mFragType: FragType, addToStack: Boolean, initializeObject: Any) {
        ...
        //getFCMtoken()
        showToolbar()
        println("load_frag " + mFragType.toString() + " " + Pref.user_id.toString() + " " + Pref.IsStockCheckFeatureOn)
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldsalesdemologsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldsalesdemologsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldsalesdemologsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
